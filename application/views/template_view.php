    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <img href="index.php" style="height:40px; margin:8px" src="<?php echo base_url('logo.png'); ?>">
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/penyewa"><i class="fa fa-users fa-fw"></i> Penyewa</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>index.php/mobil"><i class="fa fa-table fa-fw"></i> Mobil</a>
                        </li>
                        <li>
